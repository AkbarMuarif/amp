    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="<?= site_url('prs_hiburan/cek/'.$prs->no_pws)?>" class="btn btn-warning btn-flat">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="id_hbr" id="id_hbr" value="<?=$this->input->post('id_hbr') ? $this->input->post('id_hbr') : $prs->id_hbr?>">
                    </div>
                    <div class="form-group">
