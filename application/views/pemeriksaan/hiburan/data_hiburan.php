...
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Data Pemeriksaan Pajak Hiburan Nomor : <?= $prs2->no_pws?></h3>
            <div class="pull-right">
                <a href="<?= site_url('prs_hiburan')?>" class="btn btn-warning btn-flat">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="<?= site_url('prs_hiburan/edit/'.$data->id_hbr)?>" class="btn btn-info btn-sm">
        ...
        <div class="box-body">
            <div class="pull-right">
                <a href="<?= site_url('prs_hiburan/hasil/'.$data->no_pws)?>" target="blank" class="btn bg-green btn-flat">
