    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="<?= site_url('prs_restoran/cek/'.$prs->no_pws)?>" class="btn btn-warning btn-flat">
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="id_rst" id="id_rst" value="<?=$this->input->post('id_rst') ? $this->input->post('id_rst') : $prs->id_rst?>">
                    </div>
                    <div class="form-group">
