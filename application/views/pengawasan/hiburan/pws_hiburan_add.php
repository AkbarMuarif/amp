    ...
    <div class="box-body">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <?php echo form_open_multipart('pws_hiburan/add') ?>
                    ...
                    <div class="form-group <?=form_error('tipe_wp')? 'has-error' : null?>">
                        ...
                        <input type="text" name="tipe_wp" value="<?=set_value('tipe_wp')?>" id="tipe_wp" class="form-control" readonly>
                        <?=form_error('tipe_wp')?>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="tipe_id" id="tipe_id" value="<?=set_value('tipe_id')?>">
                    </div>
                    <div class="form-group">
                        <label>SSPD</label>
                    ...
                    <div class="form-group <?=form_error('izin')? 'has-error' : null?>">
                        ...
                        <select name="izin" class="form-control" id="izin">
                            ...
                            <option value="tidak" <?=set_value('izin') == "tidak" ? "selected" : null?>> TIDAK ADA </option>
                        </select>
                        <?=form_error('izin')?>
                    </div>
                    ...
                    <div class="form-group <?=form_error('bill')? 'has-error' : null?>">
                        ...
                        <select name="bill" class="form-control" id="bill">
                            ...
                            <option value="tidak" <?=set_value('bill') == "tidak" ? "selected" : null?>> TIDAK ADA </option>
                        </select>
                        <?=form_error('bill')?>
                    </div>
                    <div class="form-group <?=form_error('rekap_terima')? 'has-error' : null?>">
                        ...
                        <select name="rekap_terima" class="form-control" id="rekap_terima">
                            ...
                            <option value="tidak" <?=set_value('rekap_terima') == "tidak" ? "selected" : null?>> TIDAK ADA </option>
                        </select>
                    ...
                    <div class="form-group <?=form_error('rekap_bill')? 'has-error' : null?>">
                        ...
                        <select name="rekap_bill" class="form-control" id="rekap_bill">
                            ...
                            <option value="tidak" <?=set_value('rekap_bill') == "tidak" ? "selected" : null?>> TIDAK ADA </option>
                        </select>
