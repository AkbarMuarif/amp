...
<section class="content">
    ...
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Data Pengawasan Pajak <?=ucfirst($dt->ket_tipe)?></h3>
        </div>
                    ...
                    <tr>
                        ...
                        <?php if ($data->sspd != null) { ?>
                            <td class="text-center">
                                <a href="<?= site_url($loc.$data->sspd)?>" class="btn bg-teal btn-flat">SSPD</a>
                            </td>
                        <?php } else { ?>
                            <td></td>
                        <?php } ?>
                        <?php if ($data->sptpd != null) { ?>
                            <td class="text-center">
                                <a href="<?= site_url($loc.$data->sptpd)?>" class="btn bg-teal btn-flat">SPTPD</a>
                            </td>
                        <?php } else { ?>
                            <td></td>
                        <?php } ?>
                        <td class="text-center">
                            <a id="set_dtl" class="btn btn-default btn-sm" 
                                ...
                                <?php if($data->ket_tipe=="hotel") { ?>
                                    data-ota="<?=strtoupper($data->ota)?>"
                                <?php } ?>
                                <?php if($data->ket_tipe=="restoran") { ?>
                            ...
                            <?php if ($data->verif == 'T') { ?>
                                <a href="<?= site_url('wp_lapor/edit/'.$data->no_pws)?>" class="btn bg-green btn-sm">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a href="<?= site_url('wp_lapor/del/'.$data->no_pws)?>" onclick="return confirm('Apakah anda yakin untuk menghapus data?')" class="btn btn-danger btn-sm">
